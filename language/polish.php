...
define('_PRY_R_NO_COM',"Jeszcze nie ma komentarzy - dodaj swój u¿ywaj±c poni¿szego formularza...");
define('_PRY_R_POST',"Napisa³");
define('_PRY_R_HOMEPAGE',"Strona domowa");
define('_PRY_R_DATE_ON',"dzieñ");
define('_PRY_R_DATE_AT',"o");
define('_PRY_R_ADD_PRAYER',"Dodaj swój komentarz do tego artyku³u...");
define('_PRY_R_ADD_COM2'," ...");
define('_PRY_R_NAME',"Imiê");
define('_PRY_R_EMAIL',"E-Mail");
define('_PRY_R_EMAIL_NOT',"Twój e-mail nie bêdzie wy¶wietlany na stronie - to informacja dla administratora");
define('_PRY_R_HOMEPAGE_IN',"Strona domowa");
define('_PRY_R_COM',"Komentarz");
define('_PRY_R_FULLY',"Proszê wype³niæ ca³y formularz!");
define('_PRY_R_NEW_COM',"Nowy komenatrz");
define('_PRY_R_HAVE_NEW',"Masz nowy komentarz w nastêpuj±cym artykule:");
define('_PRY_R_LOGIN',"Proszê siê zalogowaæ i opublikowaæ b±d¼ usun±æ ten artyku³");
define('_PRY_R_QUICKLINK',"To jest szybki link do logowania");
define('_PRY_R_THANKS',"Dziêkujemy za twój komentarz");
define('_PRY_R_THANKS2',"Dziêkujemy za twój komentarz w tym artykule");
define('_PRY_R_ADMIN_REV',"Niebawem administrator przejrzy twój komentarz");
define('_PRY_R_ENTERED',"Wszed³e¶");
define('_PRY_R_VISIT',"Proszê odwied¼ wkrótce stronê");
define('_PRY_R_THANKS3',"Twój komentarz zosta³ dodany");
define('_PRY_R_THANKS4',"Twój komentarz zostanie sprawdzony przez administratora przed opublikowaniem");
define('_PRY_R_SUBMIT',"Dodaj");
define('_PRY_R_RESET',"Czy¶æ");
define('_PRY_R_NOT_AUTH',"Musisz siê zalogowaæ.");
define('_PRY_R_PREV_PAGE',"Poprzednia strona");
define('_PRY_R_NEXT_PAGE',"Nastêpna strona");
define('_PRY_R_PAGE',"Strona");
define('_PRY_R_REQUEST',"Komentarze");
define('_PRY_R_OF',"z");
define('_PRY_R_CANCEL',"Anuluj");
define('_PRY_R_FORM_INTRO',"Wpisz swój komentarz poni¿ej.");
